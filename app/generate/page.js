        ...
        <div className='flex flex-col gap-5 mt-44'>
          ...
          <div className="item">
            ...
            <div className='mx-4 flex flex-col'>
              ...
              <button disabled={pic == "" || handle=="" || links[0].linktext == ""} onClick={()=>{submitLinks()}} className='disabled:bg-slate-500 p-5 py-2 mx-2 w-fit my-5 enabled:bg-slate-900 text-white font-bold rounded-3xl'>Create your BitTree</button>
            </div>
          </div>
        </div>
      </div>
